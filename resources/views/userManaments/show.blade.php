    ...
    <div class="max-w-4xl mx-auto mt-8 bg-white shadow rounded-xl p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Manage Employes profile & roles</p>
            </div>

            <div class="flex gap-2">
                <a href="{{ route('employes.roles',$user->id) }}" 
                class="bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium px-4 py-2 rounded-md shadow transition">
                    🛡️ Manage Roles
                </a>
        ...
        <div class="space-y-6 text-gray-700">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-indigo-600 font-medium">{{ $user->email }}</p>
                </div>

                <div>
                    <x-input-label :value="'Phone Number'" />
                    <p class="mt-1 text-gray-800 font-medium">{{ $user->phone ?? 'Not added yet' }}</p>
                </div>
